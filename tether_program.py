import subprocess
import sys
from camera_utils import save_tethered_picture, choose_save_directory
...
save_tethered_picture(save_directory) # Save the latest picture taken to the 'pictures' directory
